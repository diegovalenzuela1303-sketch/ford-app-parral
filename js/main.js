document.addEventListener("DOMContentLoaded", () => {
      ...
      <article class="vehiculo-card" id="${vehiculo.id}">
        ...
        <div class="vehiculo-info">
          ...
          <div class="card-actions">
            <a class="btn btn-outline btn-dark-text" href="#contacto" data-vehiculo="${vehiculo.nombre}">Cotizar</a>
  ...
  if (catalogo && Array.isArray(window.VEHICULOS)) {
    ...
    console.error("No se encontró #catalogo-lista o window.VEHICULOS no está cargado.");
  }
